...
%LÖSUNG
\begin{frame}
  \frametitle{Wegematrizen: Lösung}
Bestimme zu Graph E eine 4x4-Wegematrix.\\
\ \\
$ A_E =
\begin{pmatrix}
...
Konstante Faktoren und Konstanten werden dabei ignoriert, d.h. $1000 n + 10$ und $0,5 n$ haben die gleiche Komplexität, nämlich $n$.
\end{frame}
