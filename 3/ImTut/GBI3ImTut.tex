...
\begin{KITexampleblock}{Definition}
	\begin{itemize}
		\item Seien $L_1, L_2$ formale Sprachen über $A$, so ist das Produkt $L_1 * L_2$ = \{$w_1 w_2 | w_1 \in L_1 \wedge w_2 \in L_2 $\}
	\end{itemize}
	\end{KITexampleblock}\\
\ \\
...
\begin{KITexampleblock}{Definition}
	\begin{itemize}
		\item Sei $L_1$ formale Sprache über $A$, so ist die Potenz $L_1^n$ die $n$-fache Verkettung von $L_1$ mit sich selbst
	\end{itemize}
	\end{KITexampleblock}\\
\ \\
...
\begin{KITexampleblock}{Definition}
	\begin{itemize}
		\item Sei $F$ formale Sprache über $A$, so ist $F^* = \bigcup\limits_{i \in \mathbb{N_0}} F^i$ der Konkatenationsabschluss von $F$
	\end{itemize}
	\end{KITexampleblock}\\
\ \\
...
\begin{KITexampleblock}{Definition}
	\begin{itemize}
		\item Sei $F$ formale Sprache über $A$, so ist $F^+ = \bigcup\limits_{i \in \mathbb{N_+}} F^i$ der  $\epsilon$-freie Konkatenationsabschluss von $F$
	\end{itemize}
	\end{KITexampleblock}\\
\ \\
Selbes wie $F^*$, nur ohne $F^0= \{ \epsilon \}$
\end{frame}
