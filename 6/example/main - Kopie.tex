...
\begin{frame}
\frametitle{Die MIMA: Aufgabe}
Schreibe ein Programm dass für ein $x \geq 0$ an Adresse adr \emph{x div 2} ausführt und und das Ergebnis wieder in adr abspeichert.
\end{frame}
...
\begin{frame}
\frametitle{Die MIMA: Aufgabe}
Schreibe ein Programm, das für den Wert x an der Adresse \emph{001} x mod 2 berechnet und das Ergebnis wieder in x speichert.
\end{frame}
...
\begin{frame}
\frametitle{Die MIMA: Aufgabe}
An Speicherstelle adr1 steht ein Wert x $\geq$ 1.\\
\ \\
Schreibe ein Programm, dass den Wert an adr2 x-mal multipliziert (adr $\cdot$ x)
\end{frame}
...
1) Schreibe ein Programm, dass den Wert an Adresse 001 verdreifacht. \\
2) Schreibe ein Programm dass für ein $x \geq 0$ an Adresse adr \emph{x div 2} ausführt und und das Ergebnis wieder in adr abspeichert. \\
3) Schreibe ein Programm, das für den Wert x an der Adresse \emph{001} x mod 2 berechnet und das Ergebnis wieder in x speichert. \\
4) An Speicherstelle adr1 steht ein Wert x $\geq$ 1.\\
Schreibe ein Programm, dass den Wert an adr2 x-mal multipliziert (adr $\cdot$ x)
\end{frame}
